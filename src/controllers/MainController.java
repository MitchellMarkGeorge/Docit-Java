...
public class MainController implements Controller  {
    ...
    @FXML private TableView<Version> tableView;
    
    // @FXML private String hello;
    @FXML private TableColumn<Version, String> versionColumn;
    @FXML private TableColumn<Version, String> dateColumn;
    @FXML private TableColumn<Version, String> commentsColumn;
...
//    Initializable
    ...
    public void initialize() {
        ...
        tableView.getItems().add(new Version("0", "00908jy", "Today", "No Comments"));
        tableView.getItems().add(new Version("1", "fjdofjdo232", "Today", "No Comments"));
        ...
        listView.setPlaceholder(new Label("hello"));
